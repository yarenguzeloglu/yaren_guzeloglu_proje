...
<meta charset="utf-8">
<link href="marmaraGrafik.css" rel="stylesheet">
...
$satis_sorgu = mysqli_query($baglanti,"SELECT urunler.urun_adi,SUM(satis.adet) AS adet FROM urunler,satis,magazalar WHERE urunler.urun_id=satis.urun_id AND satis.magaza_id=magazalar.magaza_id AND magazalar.magaza_id LIKE '159' GROUP BY urunler.urun_adi");
?>
<div class="chart">
	...
	<script>
					...
					var chart = new Chart(kanvas, {
						...
						data: { 
							labels: adlar,
							datasets: [{
								label: 'Marmara Bölgesi Toplam Ürün Satışı',
