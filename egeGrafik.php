...
<meta charset="utf-8">
<link href="egeGrafik.css" rel="stylesheet">
            ...
            <ul>                
                <li><a href="#">Grafikler</a>
                    <ul>
						...
						<li><a href="içanadoluGrafik.php">İç Anodolu</a></li>
...
$satis_sorgu = mysqli_query($baglanti,"SELECT urunler.urun_adi,SUM(satis.adet) AS adet FROM urunler,satis,magazalar WHERE urunler.urun_id=satis.urun_id AND satis.magaza_id=magazalar.magaza_id AND magazalar.magaza_id LIKE '951' GROUP BY urunler.urun_adi");
?>
<div class="chart">
