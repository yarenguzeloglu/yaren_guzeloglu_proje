...
<meta charset="utf-8">
<link href="karadenizGrafik.css" rel="stylesheet">
...
$satis_sorgu = mysqli_query($baglanti,"SELECT urunler.urun_adi,SUM(satis.adet) AS adet FROM urunler,satis,magazalar WHERE urunler.urun_id=satis.urun_id AND satis.magaza_id=magazalar.magaza_id AND magazalar.magaza_id LIKE '123' GROUP BY urunler.urun_adi");
?>
<div class="chart">
